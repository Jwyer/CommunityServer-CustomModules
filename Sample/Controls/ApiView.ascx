<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ApiView.ascx.cs" Inherits="ASC.Web.Sample.Controls.ApiView" %>

<div>
    <h1>How to create  API for your own module</h1>
    <ol>
        <li>
            Create an Class Library (ASC.Api.Sample) project<br/>
...
ASC.Web.Sample.dll
        ...
        <li>
            Create SampleApi class and implement the IApiEntryPoint interface.
<pre>
<code>
public class SampleApi : IApiEntryPoint
{
    public string Name
    {
        ...
        <li>
            Create public methods with specific attributes.
<pre>
<code>
...
&lt;ProjectToBuild Include="$(ASCDir)module\ASC.Api\ASC.Api.Sample\ASC.Api.Sample.csproj"/&gt;
        ...
        <li>
            IMPORTANT!!! Add ASC.Api.Sample.SampleApi to web\studio\ASC.Web.Studio\web.autofac.config
<pre>
<code>
&lt;component
        ...
        <li>
            Build project, run website and test the method by making a query with jQuery<br/>
            <br/>
            GET:
<pre>
<code>
